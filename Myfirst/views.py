...
def mission(request):
    text1 = "<h1> CCMS Mission</h1> \n<br> <h2>The College of Computing and Multimedia Studies shall produce competent and innovative professionals or Technopreneurs in the \
    Information and Communication Technology (ICT) industry adequately prepared in the practice of their profession supportive of national development goals and standards of global excellence.\
    </h2>"
...
def vision(request):
    text2 = "<h1> CCMS Vision</h1> \n<br><h2>The College of Computing and Multimedia Studies shall be a center of \
    excellence in delivering Computing and Multimedia education.\
    <h2>"
...
def objectives(request):
    text3 = """<h1> CCMS Objectives</h1>
    <ul>
       <li> Increase faculty performance by obtaining a minimum rating of 4.00 in the semestral faculty evaluation of each faculty for the next fiveyears.</l1>
